<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view_product.aspx.cs" CodeFile="view_product.aspx.cs" Inherits="Sport.admin.view_product" %>
            ...
            <div class="card-body">
              ...
              <table class="table datatable">
                ...
                <tbody><asp:Repeater ID="rpt" runat="server"><ItemTemplate>
                    <tr>
                    <th scope="row"><%# Eval("product_id") %></th>
                    <td><%# Eval("p_name") %></td>
                    <td><%# Eval("qty") %></td>
                    <td><%# Eval("price") %></td>
                    <td><%# Eval("material") %></td>
