<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin-index.aspx.cs" CodeFile="admin-index.aspx.cs" Inherits="Sport.admin.admin_index" %>
 ...
 <li class="nav-item">
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="filter">
                  <a class="icon" href="admin-index.aspx" data-bs-toggle="dropdown"><i class="bi bi-three-dots"></i></a>
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6><asp:Label ID="sales" runat="server"></asp:Label></h6>
              ...
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6><asp:Label ID="profit" runat="server"></asp:Label></h6>
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6><asp:Label ID="cust" runat="server"></asp:Label></h6>
              ...
              <div class="card recent-sales">
                ...
                <div class="card-body">
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      <tr>
                        <th scope="row"><a href="#"><%# Eval("check_id") %></a></th>
                        <td><%# Eval("name") %></td>
                        <td><a href="#" class="text-primary"><%# Eval("total") %></a></td>
                        <td><%# Eval("date") %></td>
                          <td><%# Eval("address") %></td>
                        <td><span class="badge bg-success"><asp:LinkButton ID="lable" runat="server" OnCommand="lable_Command" CommandArgument='<%# Eval("check_id") %>' Text="lable"></asp:LinkButton></span></td>
                         <td><span class="badge bg-success"></span><asp:LinkButton ID="done" runat="server" OnCommand="done_Command" CommandArgument='<%# Eval("check_id") %>' Text="DONE"></asp:LinkButton></td>
                      </tr>
              ...
              <div class="card recent-sales">
                ...
                <div class="filter">
                  ...
                  <asp:Repeater ID="order" runat="server">
                      <HeaderTemplate>
                <div class="card-body">
                  <h5 class="card-title">CART DETAILS <span>| Today</span></h5>
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      <tr>
                        <th scope="row"><a href="#"><%# Eval("p_name") %></a></th>
                        <td><%# Eval("name") %></td>
                        <td><a href="#" class="text-primary"><%# Eval("quantity") %></a></td>
                        <td><%# Eval("price") %></td>
                          <td><%# Eval("total") %></td>
                          <td><span class="badge bg-success"></span><asp:LinkButton ID="done" runat="server" OnCommand="done_Command1" CommandArgument='<%# Eval("email") %>' Text="EMAIL"></asp:LinkButton></td>
                      </tr>
      ...
      <asp:Repeater ID="updatedata" runat="server">
            ...
            <div class="card-body">
              ...
              <!-- General Form Elements -->
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <asp:TextBox ID="txtname" Text='<%# Eval("p_name") %>' required="" class="form-control" runat="server"></asp:TextBox>
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputsportname" class="col-sm-2 col-form-label">SPORT NAME</label>
                  <div class="col-sm-10">
                   <asp:TextBox ID="txtspname" Text='<%# Eval("sport_name") %>' required="" class="form-control" runat="server"></asp:TextBox>
                  </div>
                </div>
                 ...
                 <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                   <asp:TextBox ID="txtprice" required="" Text='<%# Eval("price") %>' class="form-control" runat="server"></asp:TextBox>
                  ...
                  <div class="col-sm-10">
                   <asp:TextBox ID="txtqty" required="" Text='<%# Eval("qty") %>' min="0" TextMode="Number" class="form-control" runat="server"></asp:TextBox>
                      <asp:CompareValidator runat="server"
                 ...
                 <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                  <asp:DropDownList ID="txtsize" class="form-control" Text='<%# Eval("size") %>' runat="server">
                 ...
                 <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                   <asp:TextBox ID="txtmaterial" Text='<%# Eval("material") %>' required="" class="form-control" runat="server"></asp:TextBox>
                  </div>
                </div>
                 ...
                 <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                   <asp:DropDownList ID="txtagerange" Text='<%# Eval("age_range") %>' class="form-control" runat="server">
                        <asp:ListItem Value="Select">Select</asp:ListItem>
                  ...
                  <div class="col-sm-10">
                      <asp:LinkButton ID="updatebtn" class="btn btn-primary" CommandArgument='<%# Eval("product_id") %>' OnCommand="updatebtn_Click"  runat="server">UPDATE</asp:LinkButton>
                  </div>
                </div>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="credits">
      ...
      Designed by <a href="https://bootstrapmade.com/">MOLLA</a>
    </div>
  </footer><!-- End Footer -->
