<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add_staff.aspx.cs" Inherits="Sport.admin.Add_staff" %>
            ...
            <div class="card-body">
              ...
              <form id="Form1" runat="server">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                     <asp:TextBox ID="txtdesignation" required="" class="form-control" runat="server"></asp:TextBox>
                  </div>
                </div>
                 ...
                 <%--<label class="col-sm-2 col-form-label">Submit Button</label>--%>
                  <div class="col-sm-10">
                    ...
                    <asp:Button ID="btnaddstaff" class="btn btn-primary" runat="server" 
                          Text="Add Staff" OnClick="btnaddstaff_Click1" ></asp:Button>
                  </div>
                </div>
