<%@ Page Title="" Language="C#" MasterPageFile="~/customer/header.Master" AutoEventWireup="true" CodeBehind="update.aspx.cs" Inherits="Sport.customer.update" %>
    ...
    <div class="page-wrapper">
        ...
        <main class="main">
            ...
            <div class="product-details-quantity">
                                                ...
                                                <asp:TextBox ID="qty" class="form-control" TextMode="Number" runat="server"></asp:TextBox>
                                            </div>
                ...
                <div class="product-details-action">
                    ...
                    <asp:LinkButton ID="up" class="btn btn-outline-primary-2" runat="server" OnClick="update_Click">
